...
Start Cmake Gui and select the "Example" directory.
You can use the same directory for both the source code and where to build the binaries.

Click configure and select your build system (Usually some version of Visual Studio)
...
If you are using Visual Studio, go to the directory where you build the binaries and open the solution file.
