...
namespace GetSetGui
{
	...
	public:
		...
		GetSetGui::GetSetTabWidget* configure()
		{
			closeWindow();
			...
			if (configuration.empty())
				return 0x0;
			window=new GetSetGui::GetSetTabWidget("",configuration, binaryFile);
			return window;
		}
	...
	protected:
		...
		GetSetGui:: GetSetTabWidget		*window;	//< The GUI to configure the client process.
