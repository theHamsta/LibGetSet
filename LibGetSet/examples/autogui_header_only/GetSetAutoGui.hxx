...
_DEFINE_TYPE(bool)  _DEFINE_TYPE(string)
_DEFINE_TYPE(char)  _DEFINE_TYPE(unsigned char)
_DEFINE_TYPE(short) _DEFINE_TYPE(unsigned short)
_DEFINE_TYPE(int)   _DEFINE_TYPE(unsigned)
_DEFINE_TYPE(long)  _DEFINE_TYPE(unsigned long)
_DEFINE_TYPE(float) _DEFINE_TYPE(double)
#undef _DEFINE_TYPE
...
namespace GetSetAutoGUI
{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Define Function which returns true in case exactly one argument --xml or ini-file
